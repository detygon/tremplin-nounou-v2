...
<!-- ====== Contact Section -->
<section id="contacts" class="bg-white py-20 lg:py-[120px] overflow-hidden relative z-10 p-9">
   <div class="container">
          ...
          <center>
              ...
              <div class="w-full lg:w-1/2 xl:w-6/12 px-4">
                 <div class="max-w-[570px] mb-12 lg:mb-0">
                    <span style="font-size: 30px" class="block mb-4 text-base text-primary font-semibold">
                    CONTACTEZ-NOUS
                    </span>
                    <h2
                       class="
                       ...
                       "
                       >
                       NOUS REPONDONS A VOS APPELS
                    </h2>
                    <p style="font-size:18px" class="text-base text-body-color leading-relaxed mb-9">
                     Prenez contact avec nous pour discuter de vos besoins dès aujourd’hui.
                     Appelez-nous, envoyez-nous un courriel et nous vous contacterons.
                    </p>
                    <div  class="flex mb-8 max-w-[370px] w-full">
                       ...
                       <div class="w-full">
                          <h4 class="font-bold text-dark text-xl mb-1">Notre adresse</h4>
                          <p class="text-base text-body-color">
                             Riviera Golf-Cocody, Abidjan Côte D'Ivoire
                          </p>
                       </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                       ...
                       <div class="w-full">
                          <h4 class="font-bold text-dark text-xl mb-1">Téléphone</h4>
                          <p class="text-base text-body-color">(+225) 2722407545</p>
                       </div>
                    </div>
                    <div class="flex mb-8 max-w-[370px] w-full">
                       <div
                       ...
                       <div class="w-full">
                          ...
                          <p class="text-base text-body-color">info@boldmanager.net</p>
                       </div>
                    </div>
                 </div>
              </div>

...
<section class="relative overflow-hidden">
    ...
    <div
        ...
        <div class="flex flex-col items-start justify-center w-full space-y-8 md:w-1/2 sm:pr-8 xl:pr-20">
            <span
                class="px-4 py-2 rounded-full border-none bg-purple-400 text-white font-medium transform -rotate-3 shadow-lg">
                Bienvenue sur Tremplin nounou
            </span>
            <h1 class="text-5xl font-bold text-pink-500 lg:text-6xl xl:text-7xl">Offrez-vous un avenir meilleur.</h1>
            <p class="text-base text-gray-800 lg:text-xl">
                Tremplin nounou offre l'opportunité aux jeunes filles déscolarisées d'apprendre un métier tout en leur permettant de reprendre leurs études, se réinserer dans la société et devenir acteur économique.
            </p>
 ...
 <a href="{{ route('profile.create') }}" class="btn btn-primary">
            ...
            &nbsp;
            <a href="{{ route('recherche.create') }}" class="btn btn-primary">
                Rechercher nounous
                <svg class="w-4 h-4 ml-2" fill="none" stroke="currentColor" viewBox="0 0 24 24"
                    xmlns="http://www.w3.org/2000/svg">
                    <path stroke-linecap="round" stroke-linejoin="round" stroke-width="2" d="M14 5l7 7m0 0l-7 7m7-7H3">
        ...
        <div class="relative flex items-center justify-center w-full mt-10 md:mt-0 md:w-1/2">
            <svg class="absolute top-0 right-0 z-0 hidden w-32 h-32 -mt-12 -mr-12 text-pink-400 fill-current md:block"
            ...
            <div class="relative cursor-pointer group">
                <div
                    ...
                    <svg xmlns="http://www.w3.org/2000/svg" class="w-3 h-auto text-pink-600 fill-current"
                        viewBox="0 0 36 50">
                        <defs></defs>
                        <path fill-rule="nonzero"
                            d="M3.167.376A2.001 2.001 0 000 2v46a2.001 2.001 0 003.167 1.624l32-23a2 2 0 000-3.248l-32-23z">
                        </path>
                    </svg>
                </div>

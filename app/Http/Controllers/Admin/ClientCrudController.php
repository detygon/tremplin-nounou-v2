...
class ClientCrudController extends CrudController
{
    ...
    protected function setupListOperation()
    {
        ...
        CRUD::addColumn(['name' => 'type_nounous', 'type' => 'text']);
        CRUD::addColumn(['name' => 'telephone', 'type' => 'text']);
        CRUD::addColumn(['name' => 'piece_identite', 'type' => 'text']);
        CRUD::addColumn(['name' => 'status', 'type' => 'text', "label"=> "adherante formation"]);
        CRUD::addColumn(['name' => 'type_auxiliaire', 'type' => 'text']);
    ...
    protected function setupCreateOperation()
    {
        ...
        CRUD::addField(['name' => 'type_nounous', 'type' => 'text']);
        CRUD::addField(['name' => 'type_auxiliaire', 'type' => 'text']);
